...
namespace QwTest7.Services.Kmp
{
    ...
    /// </summary>
    public class DbLink<TItem> where TItem : class
    {
        [Inject]
        ...
        {
            abfrage= value;
            FltrRec = KmpDbService.GetFltr(Page, Abfrage);  //null wenn nicht vorhanden ist auch gut
        ...
        public ColumnList LoadColumnlist()
        {
            ...
            {
                col.Fieldname = DbUtils.AdjustFieldname(col.Fieldname, EntityFieldlist.Keys.ToList<string>());
            }
        ...
        public string LoadKeyFields()
        {
            ...
            foreach (var keyfield in keyfields)
            {
                ...
                key[0] = DbUtils.AdjustFieldname(key[0], EntityFieldlist.Keys.ToList<string>());  //Groß/Klein korrigieren
        ...
        public FltrList LoadFltrlist()
        {
            ...
            {
                fltr.Fieldname = DbUtils.AdjustFieldname(fltr.Fieldname, EntityFieldlist.Keys.ToList<string>());
            }
            return fltrlist;
        }
        ...
        public async Task LoadData(LoadDataArgs args)
        {
            ...
            LoadAbfrage(abfrage);  //von FLTR neu einlesen (Columnlist, Fltrlist,..)
